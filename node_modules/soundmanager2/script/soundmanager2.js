...
function SoundManager(smURL, smID) {
  ...
  this.setupOptions = {
    ...
    useHTML5Audio: false,              // use HTML5 Audio() where API is supported (most Safari, Chrome versions), Firefox (MP3/MP4 support varies.) Ideally, transparent vs. Flash API where possible.
